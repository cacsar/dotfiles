...
computers are all Ubuntu, and so I intend to get these clean between all
the machines.  I use bash, but at the moment this inherits Ryan's
...
the prompt while in a git repository.  I'm in the process of adding a 
very large amount of prompt sexiness, mostly rvm-related.
